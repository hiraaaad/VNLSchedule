...
from .import_wikipedia import import_wikipedia, write_schedule
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Check Wikipedia for VNL schedule changes.")
